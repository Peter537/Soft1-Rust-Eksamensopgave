...
Det er også værd at sige at vi bruger `String` i structs fordi de bliver loaded i Runtime af en database, så hvis vi skulle holde styr på lifetimes ville det være meget kompliceret.
